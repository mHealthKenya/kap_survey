            ...
            <h2><b> Section C: Knowledge & Attitude Questions</b> </h2>
                <form role="form" method="post" action="{{route('moreDemographics')}}" >
                    ...
                    <div style="display: none;"  id="numberThirtyTwo" class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select multiple name="thirtytwo" class=" selectpicker form-control" data-width="100%" data-live-search="true">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select multiple name="sixes" class="selectpicker form-control" data-width="100% data-live-search="true" onchange='checkOtherThirtySix(this.value);'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select multiple name="sixes" class="selectpicker form-control" data-width="100% data-live-search="true" onchange='checkOtherThirtySeven(this.value);'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select multiple name="sixes" class="selectpicker form-control" data-width="100% data-live-search="true" onchange='checkOtherThirtyEight(this.value);'>
